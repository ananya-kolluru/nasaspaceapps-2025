...
# This cell demonstrates how to quickly load the data back from the
# Parquet file into a new pandas DataFrame.

file_name = PARQUET_FILE
if os.path.exists(file_name):
    print(f"\nLoading data from {file_name}...")
    try:
        df_retrieved = pd.read_parquet(file_name, engine="fastparquet")
    ...
    print(f"\nParquet file '{file_name}' not found. Please create file first.")
